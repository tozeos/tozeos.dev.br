...
const CurrentlyPlaying = () => {
	...
	if (lastFM.status !== "playing") {
		return (
			<Song href="https://www.last.fm/user/tozeos">
	...
	return (
		<Song href={lastFM.song.url}>
			<FontAwesomeIcon
				icon={faCompactDisc}
				color={lastFM.song.artist === "Queen" ? colors.yellow : colors.white}
				fixedWidth
				pulse
			/>
			<p>
...
export const About = () => {
	...
	return (
		<AboutSection id="quem-sou-eu">
			<Drawing>
				<img src={tozeos} alt="Desenho do sona do tozeos" />
			</Drawing>
			<AboutText>
				<h2>Olá, sou o tozeos!</h2>
				<p>{paragraph.first}</p>
				...
				<Donate
					...
					Hey, quer contribuir no meu aprendizado? Faça uma doação e me ajude a
					comprar um café! Clique para copiar a Chave Pix.
				</Donate>
				<CurrentlyPlaying />
			</AboutText>
		</AboutSection>
